...
[
	["UAV Terminal (NA.TO)", "B_UavTerminal", 150, "gps"],
...
[
	["Satellite Phone (base locker)", "Land_SatellitePhone_F", 70000, "object"],
	["Generator", "Land_PowerGenerator_F", 1000, "object"],  //Cael817, SNAFU,Used for base operations <-- Non destroyable
	["Portable Generator", "Land_Portable_generator_F", 500, "object"],
	["Land Device", "Land_Device_assembled_F", 1000, "object"],  //Cael817, SNAFU,Used for base operations <-- Destroyable
	["Empty Ammo Crate", "Box_NATO_Ammo_F", 200, "ammocrate"],
    //["Old Empty Ammo Crate", "Land_Box_AmmoOld_F", 200, "ammocrate"],
	["Camonet Weapons Crates", "Box_FIA_Wps_F", 1000, "object"],
    ["Explosives Crate", "Box_NATO_AmmoOrd_F", 200, "ammocrate"],
	["Empty Rocket Crate (NATO)", "Box_NATO_WpsLaunch_F", 200, "ammocrate"],
    ["Metal Barrel (fire)", "Land_MetalBarrel_empty_F", 25, "object"],
	["Camp fire", "Land_Campfire_F", 75, "object"],
	//["Camp Light", "Land_Camping_Light_off_F", 100, "object"],
	["Toilet Box", "Land_ToiletBox_F", 25, "object"],
	["Field Toilet", "Land_FieldToilet_F", 25, "object"],
	["Lamp Post (Harbour)", "Land_LampHarbour_F", 100, "object"],
	["Lamp Post (Shabby)", "Land_LampShabby_F", 100, "object"],
    ["Lamp Post (Compund)", "Land_LampHalogen_F", 500, "object"],
	["Lamp Post (Solar)", "Land_LampSolar_F", 800, "object"],
	["Sleeping Bag (folded)", "Land_Sleeping_bag_blue_folded_F", 100, "object"],
	["Sleeping Bag (open)", "Land_Sleeping_bag_blue_F", 100, "object"],
	["Pipes", "Land_Pipes_Large_F", 200, "object"],
	["Highway Guardrail", "Land_Crash_barrier_F", 200, "object"],
	["Concrete Barrier", "Land_CncBarrier_F", 200, "object"],
    ["Concrete Barrier (striped)", "Land_CncBarrier_stripes_F", 400, "object"],
	["Concrete Barrier (Medium)", "Land_CncBarrierMedium_F", 350, "object"],
	["Concrete Barrier (Long)", "Land_CncBarrierMedium4_F", 500, "object"],
    ["Road Barrier (wood)", "RoadBarrier_F", 100, "object"],
	...
	["HBarrier Wall Corridor", "Land_HBarrierWall_corridor_F", 500, "object"],
	["HBarrier Watchtower", "Land_HBarrierTower_F", 600, "object"],
	["Tin Wall v1", "Land_Wall_Tin_4", 50, "object"],
	["Tin Wall v2", "Land_Wall_Tin_4_2", 50, "object"],
	["Concrete Military Barrier", "Land_Mil_ConcreteWall_F", 400, "object"],
	["Military Wall (Big)", "Land_Mil_WallBig_4m_F", 600, "object"],
	["Military Wall (Corner)", "Land_Mil_WallBig_Corner_F", 300, "object"],
	["Military Wall (Gate)", "Land_Mil_WallBig_Gate_F", 700, "object"],
	["Concrete Wall", "Land_CncWall1_F", 400, "object"],
	["Concrete Wall (Long)", "Land_CncWall4_F", 600, "object"],
    ["Concrete Wall (layered)", "Land_Wall_IndCnc_4_F", 100, "object"],
	["Concrete Frame", "Land_CncShelter_F", 200, "object"],
    ["Concrete SmallWall (4m)", "Land_Concrete_SmallWall_4m_F", 200, "object"],
    ["Concrete SmallWall (8m)", "Land_Concrete_SmallWall_8m_F", 400, "object"],
	["Shoot House Wall (tall)", "Land_Shoot_House_Wall_F", 180, "object"],
	["Shoot House Wall (stand)", "Land_Shoot_House_Wall_Stand_F", 180, "object"],
	["Shoot House Wall (long)", "Land_Shoot_House_Wall_Long_Stand_F", 180, "object"],
	["Shoot House Wall (corner)", "Land_Shoot_House_Corner_F", 180, "object"],
	["Shoot House Wall (crouch)", "Land_Shoot_House_Wall_Crouch_F", 180, "object"],
	["Shoot House Wall (long crouch)", "Land_Shoot_House_Wall_Long_Crouch_F", 180, "object"],
	["Shoot House Wall (corner crouch)", "Land_Shoot_House_Corner_Crouch_F", 180, "object"],
	...
	["Military Cargo Post (Abandoned)", "Land_Cargo_Patrol_V2_F", 800, "object"],
	["Military Cargo Post (Brown)", "Land_Cargo_Patrol_V3_F", 800, "object"],
	["Military Cargo Tower", "Land_Cargo_Tower_V1_F", 30000, "object"],
	["Military Cargo Tower (Abandoned)", "Land_Cargo_Tower_V2_F", 30000, "object"],
	["Military Cargo Tower (Brown)", "Land_Cargo_Tower_V3_F", 30000, "object"],
	["Military Cargo Tower #1", "Land_Cargo_Tower_V1_No1_F", 30000, "object"],	
	["Military Cargo Tower #2", "Land_Cargo_Tower_V1_No2_F", 30000, "object"],	
	["Military Cargo Tower #3", "Land_Cargo_Tower_V1_No3_F", 30000, "object"],	
	["Military Cargo Tower #4", "Land_Cargo_Tower_V1_No4_F", 30000, "object"],		
	["Military Cargo HQ (green)", "Land_Cargo_HQ_V1_F", 13000, "object"],	// Cargo HQ
	["Military Cargo HQ (sand)", "Land_Cargo_HQ_V3_F", 13000, "object"],	// Cargo HQ
	["Abandoned Military Cargo HQ", "Land_Cargo_HQ_V2_F", 11000, "object"],   // Cargo HQ
	["Military Cargo House (green)", "Land_Cargo_House_V1_F" , 5000, "object"], // military cargo box
	["Military Cargo House (sand)", "Land_Cargo_House_V3_F" , 5000, "object"], // military cargo box
	["Military Cargo House (Abandoned)", "Land_Cargo_House_V2_F" , 3000, "object"], // rusty military cargo box
	["Medivac House", "Land_Medevac_house_V1_F", 6000, "object"], //Medivac house
    ["Medivac HQ", "Land_Medevac_HQ_V1_F", 14000, "object"],     //Medivac HQ
    ["Research HQ", "Land_Research_HQ_F", 14000, "object"],         //Research HQ
    ["Research House", "Land_Research_house_V1_F", 6000, "object"], //Research House
    ["Canal Wall (Large)", "Land_Canal_Wall_10m_F", 400, "object"],
	...
	["Concrete Slab", "BlockConcrete_F", 500, "object"],
	["Concrete Pipe", "Land_ConcretePipe_F", 300, "object"],
	["Pipe Fence", "Land_Pipe_fence_4m_F", 600, "object"],
	["Barbed Wire Fence", "Land_Mil_WiredFence_F", 200, "object"],
	//["New 10M Barbed Wire Fence (damaged)", "Land_New_WiredFence_10m_Dam_F", 300, "object"],
	["New 10M Barbed Wire Fence (10m)", "Land_New_WiredFence_10m_F", 300, "object"],
	["New 5M Barbed Wire Fence (5m)", "Land_New_WiredFence_5m_F", 200, "object"],
	["Barbed wire Gate", "Land_Mil_WiredFence_Gate_F", 250, "object"],
	["Boom Gate", "Land_BarGate_F", 150, "object"],
    ["Net Fence (4m)", "Land_Net_Fence_4m_F", 200, "object"],
    ["Net Fence (8m)", "Land_Net_Fence_8m_F", 200, "object"],
    ["Net Fence Gate", "Land_Net_Fence_Gate_F", 400, "object"],
    ["Obstacle Ramp", "Land_Obstacle_Ramp_F", 50, "object"],
	["Obstacle Bridge", "Land_Obstacle_Bridge_F", 50, "object"],
    ["Obstacle Ladder", "Land_Obstacle_Climb_F", 100, "object"],
	["Scaffolding", "Land_Scaffolding_F", 250, "object"],
    ["Long Stairs", "Land_GH_Stairs_F", 300, "object"],
	["wooden pier", "Land_Pier_small_F", 300, "object"],
    ["Military Sign", "Land_Sign_WarningMilitaryArea_F", 150, "object"],
	["Food sacks", "Land_Sacks_goods_F", 5000, "object"], // Added on player request
	["Food Crates", "Land_CratesWooden_F", 10000, "object"],
	["Water Barrel", "Land_BarrelWater_F", 5000, "object"], // Added on player request
	["Water Tank", "Land_WaterTank_F", 10000, "object"],
	["Wind Sock", "Windsock_01_F", 500, "object"],
	
	//new items
	
	//["Barbed Wire Fence Pole", "Land_New_WiredFence_pole_F", 100, "object"],
	["Tent (camo)", "Land_TentA_F", 200, "object"], 
	/*["Bridge", "Land_Bridge_01_PathLod_F", 500, "object"],
	["Asphalt Bridge", "Land_Bridge_Asphalt_PathLod_F", 2000, "object"],*/
	["Decorative Street Lamp", "Land_LampDecor_F", 500, "object"],
	["Navigation Light", "Land_NavigLight", 700, "object"],
	["Vehicle Shelter (big)", "Land_Shed_Big_F", 5000, "object"],
	["Vehicle Shelter (small)", "Land_Shed_Small_F", 3000, "object"],
	["Stone Wall (4m)", "Land_Stone_4m_F", 300, "object"],
	["Stone Wall (8m)", "Land_Stone_8m_F", 600, "object"],
	["Stone Wall Gate", "Land_Stone_Gate_F", 700, "object"],
	["Stone Pillar", "Land_Stone_pillar_F", 200, "object"],
	["Shack", "Land_Slum_House02_F", 500, "object"],
	["Slum house (cargo box)", "Land_cargo_house_slum_F", 1000, "object"],
    ["Metal shed", "Land_Metal_Shed_F", 500, "object"],
	["Slum Addon V1", "Land_cargo_addon01_V1_F", 500, "object"],
	["Slum Addon V2", "Land_cargo_addon01_V2_F", 500, "object"],
    ["Wooden Bench", "Land_Bench_F", 200, "object"],
	["Shelves", "Land_Metal_wooden_rack_F", 100, "object"],
	["Shelves (Metal)", "Land_Metal_rack_F", 100, "object"],
	["Shelves (wooden)", "Land_ShelvesWooden_khaki_F", 100, "object"],
	["Cargo Container (Box)", "Land_CargoBox_V1_F", 500, "object"],
	["Cargo Container (Mil Green)", "Land_Cargo20_military_green_F", 1000, "object"],
	["Cargo Container (sand)", "Land_Cargo20_sand_F", 1000, "object"],
	["Cargo Container (grey)", "Land_Cargo20_grey_F", 1000, "object"],
	["Cargo Container (Red)", "Land_Cargo20_brick_red_F", 1000, "object"],
	["Cargo Container (blue)", "Land_Cargo20_cyan_F", 1000, "object"],
	["Large Cargo Container (Hemtt box only)", "Land_Cargo40_military_green_F", 1500, "object"], //Transport by Hemtt only
	["Large Cargo Container (sand)(Hemtt box only)", "Land_Cargo40_sand_F", 1500, "object"], //Transport by Hemtt only
	["Large Cargo Container (grey)(Hemtt box only)", "Land_Cargo40_grey_F", 1500, "object"], //Transport by Hemtt only
	["Junk Pile", "Land_JunkPile_F", 50, "object"],
	["Tire Pile", "Land_Tyres_F", 75, "object"],
	["Rusty Tank", "Land_Tank_rust_F", 75, "object"],
	["Timbers", "Land_Timbers_F", 50, "object"],
	["Wood Pile", "Land_WoodPile_F", 50, "object"],
	["Work Light (single)", "Land_PortableLight_single_F", 100, "object"],
	["Work Light (double)", "Land_PortableLight_double_F", 200, "object"],
	//["Light (halogen no stand)", "Land_FloodLight_F", 100, "object"],
	//["Camp fire (burning)", "Campfire_burning_F", 75, "object"],
	["Garage", "Land_i_Shed_Ind_F", 2000, "object"],
	//["Concrete Pier", "Land_Pier_F", 1000, "object"],
	["Pier Ladder", "Land_PierLadder_F", 500, "object"],
	["Range Target", "TargetP_Inf_F", 500, "object"],
	["Range Zombie Target", "TargetP_Zom_Acc1_F", 500, "object"],
	["Target (simple)", "Target_F", 100, "object"],
	["Platform", "Land_GH_Platform_F", 300, "object"],
	/*["Transmitter Tower (Big)", "Land_TTowerBig_1_F", 3000, "object"],
	["Communications Tower", "Land_TTowerBig_2_F", 2500, "object"],
	
	["Vehicle Camo Net", "CamoNet_INDP_big_F", 500, "object"],
	["Runway Edge Light (blue)", "Land_runway_edgelight_blue_F", 200, "object"],
    ["Runway Edge Light", "Land_runway_edgelight", 200, "object"],
    ["Runway Light (flush yellow)", "Land_Flush_Light_yellow_F", 300, "object"],
    ["Runway Light (flush red)", "Land_Flush_Light_red_F", 300, "object"],
    ["Runway Light (flush green)", "Land_Flush_Light_green_F", 300, "object"],*/
	["Marker pole", "Pole_F", 2, "object"]
	//["Helipad (symb)", "Land_HelipadCircle_F", 1000, "object"]
...
[
	[ // Main colors
		...
		[
			...
			["Beach", _texDir + "Beach.paa"],
			["Blue Camo 1", _texDir + "Blue camo.paa"],
			["Carbon Fiber", _texDir + "Carbon.paa"],
			["Construction",  _texDir + "construction.paa"],
			["Snow Camo", _texDir + "Clothcamo.paa"],
			["Desert Camo 1", _texDir + "Desert1.paa"],
			["Desert Camo 2",  _texDir + "DesertCamo2.paa"],
			["DigiCam", _texDir + "Digicam.paa"],
			["Hi TeK I", _texDir + "Hi_Tek.paa"],
			["Hi TeK II", _texDir + "Hi_Tek2.paa"],
			["Hippie", _texDir + "Hippie.paa"],
			["Murica", _texDir + "Murica.paa"],
			["Navy", _texDir + "Navy.paa"],
			["Psych", _texDir + "Psych.paa"],
			["Real Tree", _texDir + "Realtree.paa"],
			["Real Tree II", _texDir + "Realtree2.paa"],
			["Rusty Camo", _texDir + "Rustycamo.paa"],
			["Skulls", _texDir + "Skullz.paa"],
			["Snake", _texDir + "Snake.paa"],
			["Snow Camo", _texDir + "Snowcamo.paa"],
			["Stripes (hummingbird or Pawnee)", _texDir + "Stripes.paa"],
			["Stripes II (hummingbird or Pawnee)", _texDir + "Stripes2.paa"],
			["Stripes III", _texDir + "Stripes3.paa"],
			["Tiger", _texDir + "Tiger.paa"],
			["Tron I", _texDir + "Tron.paa"],
			["Tron II", _texDir + "Tron1.paa"],
			["Tron III", _texDir + "Tron2.paa"],
			["Tundra", _texDir + "Tundra.paa"],
			["Tundra II", _texDir + "Tundra2.paa"],
			["Tundra III", _texDir + "Tundra3.paa"],
			["Tundra IV", _texDir + "Tundra4.paa"],
			["Union Jack", _texDir + "Unionjack.paa"],
			["Woodland Camo 1", _texDir + "Woodland_1.paa"],
			["Woodland Camo 2", _texDir + "Woodland_2.paa"],
			["Woodland Camo 3", _texDir + "Woodland_3.paa"],
            ["Woodland Camo 4", _texDir + "Woodland_4.paa"],
            ["Woodland Camo 5", _texDir + "Woodland5.paa"],
            ["Woodland Camo 7", _texDir + "Woodland_7.paa"],
			["Woodland Camo 6", _texDir + "Woodland6.paa"],
			["Woodland Camo 8", _texDir + "Woodland8.paa"],
            ["Woodland Camo 9", _texDir + "Woodland9.paa"],
            ["Woodland Camo 10", _texDir + "Woodland10.paa"],
			["Woodland Camo 11", _texDir + "Woodland11.paa"],
			["Woodland Camo 12", _texDir + "Woodland12.paa"],
			/*["test 1",  _texDir + "test1.paa"],
			["test 3",  _texDir + "test3.paa"],*/
			["Zebra", _texDir + "Zebra.paa"]
